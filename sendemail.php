...
function sendemail($mail_username,$mail_userpassword,$mail_setFromEmail,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject, $template){
	...
	$mail->Host = 'mail.novoexpert.net';             // Especificar el servidor de correo a utilizar 
	$mail->SMTPAuth = true;                     // Habilitar la autenticacion con SMTP
	$mail->Username = 'info@novoexpert.net';          // Correo electronico saliente ejemplo: tucorreo@gmail.com
