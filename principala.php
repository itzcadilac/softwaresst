				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							echo "
							<form name=formderivar action=controlador.php?pagina=1 method=post>
...
while($row=mysqli_fetch_array($result))
{
 echo "
	...
	<tr>
         <td align='center'>  
		 <input type=checkbox name=idesolicitud[] title=Seleccione para Aprobar onClick='CambiaFilColor(this,this.id);' 
		 ...
		 <b>-Tipo Capacitación: </b>".$row[nombcapacitacion]." <br>
