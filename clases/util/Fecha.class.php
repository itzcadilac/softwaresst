...
class Fecha {
  ...
  /* public:      mesTexto
   * mes:         mes en forma num�rica
   * Devuelve el mes en formato texto (y en espa�ol, claro)
   */
  ...
  /***************************************************************************/
  /* public:      operar
   * segundos:    segundos que se a�adir�n a la fecha
...
//echo $fecharecep[$x]." - ".date("Y-m-d 00:00:00")." N� Reg:".$c++."<br>";
			}else{
				$valores[]=$this->Calculodias($fecharecep[$x],$fechaderiv[$x+1]);
				//echo $fecharecep[$x]." - ".$fechaderiv[$x+1]." N� Reg:".$c++."<br>";
			}	
