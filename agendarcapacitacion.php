...
return /\d/.test(String.fromCharCode(keynum));
							...
							<!-- <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="company" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
							</div>
							<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" name="numpart" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
							</div>
							...
							<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="email" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
							</div>
							<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="numcontac" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" onkeypress="return solonumero(event);"/>
										</div>
							</div> -->
							<div class="form-group">
