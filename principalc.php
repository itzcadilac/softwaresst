...
/* Abrimos la base de datos */
  ...
  $sql='SELECT sl.razons as razonsocial, sl.ruc as rucs, pr.dscparametro as estadosol, sl.*
  FROM solicitudcapac sl, parametro pr
  where pr.idetipparametro = "TIP_ESTADOSOL"
  AND sl.estadosolic = pr.codparametro
  and sl.ruc = "'.$ruc_s.'"
  ORDER BY idesolicitud ASC' ;
 
$result= mysqli_query($conx,$sql) or die(mysql_error());
 ...
 echo "
	...
	<tr>
		<td align='center'> 
		 ...
		 <b>-Operación: </b>".$row[numoperpago]." <br>
		 <b>-Fecha Pago: </b>".$row[fechapago]." <br>
		 <b>-Hora Pago: </b>".$row[horapago]." 
		 </td>
