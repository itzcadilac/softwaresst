                    ...
                    <tbody>
                      <tr>
                        <td style='font-family: Arial, Helvetica, sans-serif; color: #000000;'>
                          <span style='font-size: 18px; line-height: 28px;'><strong>".$_SESSION['nombre_aut']." de Nestle Perú, </strong></span>
                          <p style='margin: 10px 0 24px; font-size: 24px; line-height: 36px;'>
                            Ha autorizado la Solicitud Nro. ".$_SESSION['idesolicitud']."
                          </p>
                        </td>
                      </tr>
                    </tbody>
