...
$sendTo = "'".$_SESSION['nombresAut']."'". "<".$_SESSION['correo_destino'].">"; //<ventas@novoexpert.net>; // Add Your Email
$subject = 'Solicitud Recibida - Autorizador';
                      ...
                      <tr>
                        <td style='font-family: Arial, Helvetica, sans-serif; color: #000000;'>
                          ...
                          <p style='margin: 10px 0 24px; font-size: 24px; line-height: 36px;'>
                            Ha enviado una nueva Solicitud para Capacitación.
                          </p>
                        </td>
                      </tr>
                    </tbody>
                ...
                <td style='padding: 0 10%; font-family: Arial, Helvetica, sans-serif; color: #494F66;'>
                  ...
                  <table role='presentation' cellspacing='0' cellpadding='0' align='center' border='0'
                    ...
                    ".$_SESSION['numruc']."
                      ...
                      <a href='https://software.sstasesores.pe/' style='display: block; width: 220px; height: 31px; text-decoration: none; text-align: center; padding-top: 17px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; color:#ffffff; border-radius: 4px; background: #40507d;'>IR A SOLICITUD</a>
                    </td>
                    </tr>
                      <tr>
                        <td colspan='2'>
                          <table style='background: #FFEFD8;border-radius: 8px;padding: 16px 16px;margin: 48px 0 40px;'>
                            <tbody>
                              <tr
                                ...
                                <td>
                                  Recuerda que, debes revisar la información de la solicitud para poder Autorizarla.
                                </td>
                              </tr>
                            </tbody>
                          </table>
