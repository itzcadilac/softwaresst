...
/* Abrimos la base de datos */
  ...
  $fechabus = $_SESSION['fechabus'];
  
if($fechabus==""){
$sql="SELECT e.idexpediente, e.seguimiento,e.remitente, t.denominacion, a.abreviatura_area as 'abrevarearecibe',e.asuntonotupa, h.fecha_mov, h.estadoexp,h.actual,e.idtupa,if(h.recepcionado=1, 'Recepcionado', 'No Recepcionado') as 'recepcionado',e.estados,do.detalledocumento,dae.numerodoc,a.descripcion_area as 'descripcionarearecibe',dae.folios as 'folenvio',da.folios,dae.referenciaenvio,e.tipo FROM expediente e, historial h, areas a , tupa t, documentos do, detalleenvio dae,documentosadjuntos da WHERE e.idexpediente=h.idexpediente and h.idarearecibe=a.idarea and dae.idenvio=h.idenvio and dae.iddocumento=do.iddocumento and da.idexpediente=e.idexpediente and da.correlativo=0 and t.idtupa=e.idtupa and h.estadoexp=6 and h.idareaenvia='".$_SESSION['idarea']."' and date(h.fecha_mov)=curdate() ORDER BY h.fecha_mov desc ";

}
else if($fechabus!=""){ 

$sql="SELECT e.idexpediente, e.seguimiento,e.remitente, t.denominacion, a.abreviatura_area as 'abrevarearecibe',e.asuntonotupa, h.fecha_mov, h.estadoexp,h.actual,e.idtupa,if(h.recepcionado=1, 'Recepcionado', 'No Recepcionado') as 'recepcionado',e.estados,do.detalledocumento,dae.numerodoc,a.descripcion_area as 'descripcionarearecibe',dae.folios as 'folenvio',da.folios,dae.referenciaenvio,e.tipo FROM expediente e, historial h, areas a , tupa t, documentos do, detalleenvio dae,documentosadjuntos da WHERE e.idexpediente=h.idexpediente and h.idarearecibe=a.idarea and dae.idenvio=h.idenvio and dae.iddocumento=do.iddocumento and da.idexpediente=e.idexpediente and da.correlativo=0 and t.idtupa=e.idtupa and h.estadoexp=6 
and h.idareaenvia='".$_SESSION['idarea']."' and date(h.fecha_mov)='".$fechabus."' ORDER BY h.fecha_mov desc";
}

$result= mysql_query($sql) or die(mysql_error());


//session_unset(fechabus);
?>
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					<a href="principal.php" class="navbar-brand">
						...
						<span class="badge badge-danger">AREA:</span> <label style="color:white;"><?php echo $_SESSION['nomarea']; ?>
...
-->
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<form name="formderivar" action="controlador.php?pagina=4" method="post">
						<div class="page-header">
							<h1>
								Historial de Expedientes Derivados
								<small>
											...
											<div class="widget-box">
												<div class="widget-body">
													<div class="widget-main">
														<label for="id-date-picker-1">Ingresar una Fecha</label>

														<div class="row">
															<div class="col-xs-8 col-sm-11">
																<div class="input-group">
																	<input class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" name="date" />
 ...
 echo "
		...
		Listado de Expedientes Derivados /  <a href=controlador.php?pagina=29&orden=4&tip=1&fecha=".$fechabus." target=_blank style=color:white>  Vista de Impresion</a>
...
while($row=mysql_fetch_array($result))
{
 echo "
	...
	<tr>
         ...
         <td width=45% class=hidden-480><b>-Area: ".$row[descripcionarearecibe]."</b> <br><b>-Referencia: </b>".$row[referenciaenvio]." <br><b>-Doc.:</b> ".$row[detalledocumento]." - ".$row[numerodoc]." <br><b>-Fecha Env.: </b>".$row[fecha_mov]." <br><b>-Folios:</b> ".$row[folenvio]." </td>
		 <td> 
			".$row[recepcionado]."
		 </td>
		 <td> ";
		 
		 if ($row[recepcionado] == 'Recepcionado') {
				echo "";
			}
			 else {
				echo "<input type=button value=Cancelar Envio onclick=cancelar('controlador.php?pagina=8&idexpediente=".$row[idexpediente]."');>";
			}
		echo "</td>
      </tr>
	  </tbody>
...
function cancelar(direccion){
  if (confirm('¿Esta seguro de cancelar el envio?')){
