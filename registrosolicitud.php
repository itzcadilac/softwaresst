...
<div class="alert alert-danger" role="alert" style="display: none" id="div_danger">
  ...
  <p>Tu El registro de la solicitud no se pudo realizar, intenta nuevamente.</p>
</div>
    ...
    //$("input#divautoriza").val('');
							...
							<div class="form-group" id="divautoriza">
										...
										<span> Ingrese el Nombre y/o Apellidos de Su Autorizador y Seleccionelo, sino se encuentra comúniquese con la Empresa para su Registro. </span>
											<input class="typeahead scrollable" id="autorizador" type="text" placeholder="Escriba aquí Nombres y Apellidos del Autorizador" required/>
										</div>
							</div>
...
?>
										<div class="col-sm-9">
											<select class="chosen-select form-control" name="tipcapacitaciones[]" id="tipcapacitaciones" data-placeholder="Escoge tu Capacitación..." required>
											<option value="0">---Seleccione---</option>
											<?php echo $combobit; ?>
											</select>
										</div>
