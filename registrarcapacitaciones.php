...
<form class="form-horizontal" role="form" id="frm" name="formregistrar" action="capacitacionesservices.php" method="post" enctype="multipart/form-data">
...
if ($result->num_rows > 0)
{
    ...
    while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
        $combobit .= " <option value='" . $row['idecalendcapacitaciones'] . "'>" .$row['desccapacitacion']. " " .$row['fecha']."</option>"; //concatenamos el los options para luego ser insertado en el HTML
    }
} else {
    echo "";
}
...
?>
              ...
              <div class="col-sm-9">
                <select class="chosen-select form-control" name="tipcapacitacion" id="tipcapacitacion" data-placeholder="Seleccione la capacitación">
                  <?php echo $combobit; ?>
                </select>
              </div>
              </div>
                      ...
                      <div class="input-group">
                        ...
                        <span class="input-group-addon">
                          <i class="fa fa-calendar bigger-110"></i>
											...
											<!-- <input type="text" name="day" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" /> -->
										</div>
							</div>
							<div class="form-group">
                      ...
                      <div class="input-group bootstrap-timepicker">
                        ...
                        <span class="input-group-addon">
                          <i class="fa fa-clock-o bigger-110"></i>
											...
											<!-- <input type="text" name="hour" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" onkeypress="return solonumero(event);"/> -->
										</div>
							</div>
							<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre de capacitador: </label>

										<div class="col-sm-9">
                      <select class="chosen-select form-control" name="trainer" id="form-field-select-3" data-placeholder="Escoja al capacitador">
                        <?php echo $trainerCombo; ?>
											</select>
											<!-- <input type="text" name="trainer" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" onkeypress="return solonumero(event);"/> -->
										</div>
							</div>
							</div>
							<div  class="form-group" >
