													...
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="img-responsive" alt="Foto Usuario" id="avatar2" 
															...
															<div class="profile-user-info">
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		...
																		<span class="editable" id="country"><?php echo $row1[pais];?></span>
																		<span class="editable" id="city"><?php echo $row1[departamento];?></span>
																	</div>
																</div>
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span class="editable" id="age"><?php echo $edad;?></span>
																	</div>
																</div>
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span class="editable" id="signup"><?php echo $row1[fecha_nacimiento]; ?></span>
																	</div>
																</div>
															...
															<div class="widget-box transparent">
																...
																<div class="widget-body">
																	<div class="widget-main">
																		<span span class="editable" id="about"> <?php echo $row1[acerca];?> </span>
																	</div>
																</div>
															</div>
														</div>
